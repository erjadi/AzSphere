...
#include <time.h>
	...
	uint16_t io_timeout;
	bool did_timeout;
	struct timespec timeout_start_ms;
	...
	DistanceMode VL53L1X_getDistanceMode(void);
	...
	uint16_t readRangeContinuousMillimeters(bool blocking);
